...
def recommend():
    ...
    try:
        ...
        # weight_input removed as per new requirements

        # --- 1. Filter Materials ---
        # Logic: Filter based on Fragility constraints
        filtered_df = df_base.copy()
        
        if fragility == 'High':
            filtered_df = filtered_df[filtered_df['strength_score'] > 70]
        elif fragility == 'Medium':
            filtered_df = filtered_df[filtered_df['strength_score'] > 40]
        ...
        for _, row in filtered_df.iterrows():
            ...
            suitability_score = (
                ...
                0.2 * (features['biodegradability_score'] / 10)
            )
